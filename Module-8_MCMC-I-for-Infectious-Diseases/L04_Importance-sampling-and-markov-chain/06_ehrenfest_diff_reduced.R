...
my_draws[1] = next_state(cur.state = 1, num.mol = my_num_mol)#FINISH AND UNCOMMENT THIS LINE
...
for (i in 2:sim_size){
  ...
  my_draws[i] = next_state(cur.state = my_draws[i-1], num.mol = my_num_mol)#FINISH AND UNCOMMENT THIS LINE
}
